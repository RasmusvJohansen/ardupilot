...
private:
    ...
    VectorN<float,num_of_states>u;
    VectorN<float,num_of_states>prev_x;
    VectorN<float,num_of_states>w;


    float roll, pitch, yaw, x_inertia, y_inertia, z_inertia, mass, thrust_constant, ang_velo_m1, ang_velo_m2, ang_velo_m3, ang_velo_m4;
    ...
    float roll_vel = prev_x[10] + roll_acc *time_step;
    float pitch_vel = prev_x[11] + pitch_acc *time_step;
    float yaw_vel = prev_x[12] + yaw_acc *time_step;
    ...
    float x_vel = prev_x[7] + x_acc * time_step;  
    float y_vel = prev_x[8] + y_acc * time_step;  
    float z_vel = prev_x[9] + z_acc * time_step;  
    ...
    float next_p[num_of_states][num_of_states];
    float f[num_of_states][num_of_states];
    ...
    VectorN<float,num_of_states> dynamicsFunction(VectorN<float,num_of_states>x, VectorN<float,num_of_states> u)
    {
